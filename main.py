...
from CreateRelations import makeSt1
...
#-- Making relations
#print rootArgs
rootSt0=makeSt0(rootArgs)
print "St0-"+str(root)+": "+str(rootSt0)
pred0St0=makeSt0(pred0Args)
print "St0-"+str(pred0)+": "+str(pred0St0)


rootSt1=makeSt1(rootMixedArgs)
if rootSt1!=None:
   print "St1-"+str(root)+": "+"St0-"+str(root)+" "+str(rootSt1)+" Arg2-"+str(root0)

pred0St1=makeSt1(pred0MixedArgs)
if pred0St1!=None:
   print "St1-"+str(pred0)+": "+"St0-"+str(pred0)+ " "+str(pred0St1)+" Arg2-"+str(pred0)
